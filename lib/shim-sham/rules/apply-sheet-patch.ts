...
import { applyRecoveryCheck } from "@/lib/shim-sham/rules/recovery-check";
import { shouldClearCoverForUnconscious } from "@/lib/shim-sham/rules/cover";
import {
  adjustCurrentHpForDrainedChange,
  effectiveMaxHp,
  tickRestConditions,
} from "@/lib/shim-sham/rules/condition-effects";
import { getNextLevelSnapshot, requireLevelSnapshot } from "@/lib/shim-sham/data/progression";
import type { SheetPatch } from "@/lib/shim-sham/rules/patch";
import {
  pickCompanionPatchFields,
  pickDirectPatchFields,
} from "@/lib/shim-sham/rules/patch-security";
import { applyEncounterOffReset } from "@/lib/shim-sham/rules/runtime-reset";

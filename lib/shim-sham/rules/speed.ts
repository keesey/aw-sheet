import { ACCELERATE_SPEED_BONUS } from "@/lib/shim-sham/data/constants";
import { PAHTRA_LAND_SPEED } from "@/lib/shim-sham/data/ancestry";
import {
  COMMERCIAL_JETPACK_FLY_SPEED,
  hasJetpackInstalled,
} from "@/lib/shim-sham/rules/jetpack";
import { stylishSpeedBonus } from "@/lib/shim-sham/rules/stylish-speed";
import type { LevelSnapshot } from "@/lib/types";
import { modifiedSpeed } from "@/lib/shim-sham/rules/condition-effects";
